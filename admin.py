...
lf_bg = '#b3072c' # bg color for the left_frame
cf_bg = 'Wheat' # bg color for the center_frame
...
Label(main, text="Attendance MANAGEMENT SYSTEM", font=headlabelfont, bg='DarkRed',fg="White").pack(side=TOP, fill=X)
...
Button(center_frame, text='Delete Record', font=labelfont, command=remove_record, width=15).place(relx=0.15, rely=0.25)
Button(center_frame, text='View Record', font=labelfont, command=view_record, width=15).place(relx=0.15, rely=0.35)
Button(center_frame, text='Reset Fields', font=labelfont, command=reset_fields, width=15).place(relx=0.15, rely=0.45)
Button(center_frame, text='Delete database', font=labelfont, command=reset_form, width=15).place(relx=0.15, rely=0.55)

# Placing components in the right frame
Label(right_frame, text='Students Records', font=headlabelfont, bg='Wheat', fg='#e0b802').pack(side=TOP, fill=X)
